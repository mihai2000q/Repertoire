...
import SongInformationWidget from './SongInformationWidget.tsx'
import Difficulty from '../../../types/enums/Difficulty.ts'
import dayjs from 'dayjs'
import { http, HttpResponse } from 'msw'
import { setupServer } from 'msw/node'

describe('Song Information Widget', () => {
  const handlers = [
  ...
  it('should render when there is no information', () => {
    reduxRender(<SongInformationWidget song={emptySong} />)
  ...
  it('should render when there is information', async () => {
    ...
    reduxRender(<SongInformationWidget song={song} />)
