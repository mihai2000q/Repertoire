...
interface SongOverallWidgetProps {
  song: Song
}

function SongOverallWidget({ song }: SongOverallWidgetProps) {
  return (
    <Card variant={'widget'} aria-label={'overall-widget'} p={'md'}>
      <Stack gap={'xs'}>
        <Tooltip
...
export default SongOverallWidget
