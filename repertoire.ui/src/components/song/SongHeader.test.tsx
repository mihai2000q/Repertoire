...
describe('Song Header', () => {
  ...
  it('should render and display minimal info', async () => {
    reduxRouterRender(<SongHeader song={song} />)
  ...
  it('should render and display maximal info', async () => {
    ...
    reduxRouterRender(<SongHeader song={localSong} />)
  ...
  it("should display song's image if the song has one, if not the album's image", () => {
    ...
    const [{ rerender }] = reduxRouterRender(<SongHeader song={localSong} />)
    ...
    rerender(<SongHeader song={localSongWithAlbum} />)
  ...
  it('should display image modal, when clicking the image', async () => {
    ...
    reduxRouterRender(<SongHeader song={{ ...song, imageUrl: 'something.png' }} />)
  ...
  describe('on menu', () => {
    ...
    it('should display warning modal and delete song', async () => {
      ...
      reduxRouterRender(withToastify(<SongHeader song={song} />))
  ...
  it('should open artist drawer on artist click', async () => {
    ...
    const [_, store] = reduxRouterRender(<SongHeader song={localSong} />)
