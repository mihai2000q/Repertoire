...
describe('Playlist Header', () => {
  ...
  it('should render and display minimal info', async () => {
    ...
    reduxRouterRender(<PlaylistHeader playlist={playlist} />, {
  ...
  it('should display image modal, when clicking the image', async () => {
    ...
    reduxRouterRender(<PlaylistHeader playlist={{ ...playlist, imageUrl: 'something.png' }} />)
  ...
  describe('on menu', () => {
    ...
    it('should display warning modal and delete playlist', async () => {
      ...
      reduxRouterRender(withToastify(<PlaylistHeader playlist={playlist} />))
