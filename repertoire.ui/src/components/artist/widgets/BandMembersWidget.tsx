...
function BandMembersWidget({ bandMembers, artistId, isFetching }: BandMembersWidgetProps) {
  ...
  return (
    <Card aria-label={'band-members-widget'} variant={'widget'} p={0}>
      <Stack gap={0}>
...
export default BandMembersWidget
