...
describe('Album Header', () => {
  ...
  it('should render and display minimal info when the album is not unknown', () => {
    reduxRouterRender(
      <AlbumHeader album={album} isUnknownAlbum={false} songsTotalCount={undefined} />
    )
  ...
  it('should render and display maximal info when the album is not unknown', async () => {
    ...
    reduxRouterRender(
      <AlbumHeader album={localAlbum} isUnknownAlbum={false} songsTotalCount={undefined} />
    )
  ...
  it('should render and display info when the album is unknown', async () => {
    ...
    reduxRouterRender(
      <AlbumHeader album={undefined} isUnknownAlbum={true} songsTotalCount={songsTotalCount} />
    )
