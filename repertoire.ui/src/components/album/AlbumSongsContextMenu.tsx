...
interface AlbumSongsContextMenuProps {
  children: ReactNode
  albumId: string
  isUnknownAlbum: boolean
}

function AlbumSongsContextMenu({ children, albumId, isUnknownAlbum: isUnknownAlbum }: AlbumSongsContextMenuProps) {
...
export default AlbumSongsContextMenu
