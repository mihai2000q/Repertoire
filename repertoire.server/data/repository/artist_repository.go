...
type ArtistRepository interface {
	...
	GetAllByIDsWithSongPartsAndDefaultOccurrences(artists *[]model.Artist, ids []uuid.UUID) error
	GetAllByUser(
	...
	ReplaceBandMemberRoles(bandMember *model.BandMember, roles []model.BandMemberRole) error
...
func (a artistRepository) GetAllByIDsWithSongPartsAndDefaultOccurrences(artists *[]model.Artist, ids []uuid.UUID) error {
	return a.client.Model(&model.Artist{}).
...
func (a artistRepository) ReplaceBandMemberRoles(bandMember *model.BandMember, roles []model.BandMemberRole) error {
