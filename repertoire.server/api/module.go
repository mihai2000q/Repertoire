...
var handlers = fx.Options(
	...
	fx.Provide(handler.NewSongArrangementHandler),
	fx.Provide(handler.NewSongPartHandler),
...
var routers = fx.Options(
	...
	fx.Provide(router.NewSongArrangementRouter),
	fx.Provide(router.NewSongPartRouter),
